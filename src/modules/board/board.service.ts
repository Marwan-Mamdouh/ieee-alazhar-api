import { boardMembersProps, type MemberType } from "./board.types.js";
...
const boardService = {
  ...
  updateBoard: async (boardId: string, boardData: Partial<BoardDocument>) => {
...
const toMemberDTO = (member: BoardDocument | BoardMember) => {
  return {
    id: `${member._id}`,
    name: member.name,
    bio: member.bio,
