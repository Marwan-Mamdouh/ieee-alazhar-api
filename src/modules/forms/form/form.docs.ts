...
// -----------------------------------------------------------------------
// Output schemas — mirror the DTOs in form.dto.ts
// -----------------------------------------------------------------------
...
registry.registerPath({
  ...
  description:
    "The slug is derived automatically from the title by the server — do not send one. The _email system field is injected on creation.",
  security: [{ cookieAuth: [] }],
  request: {
    body: {
      content: {
  ...
  responses: {
    201: {
      description: "Form created — the _email system field is injected",
      content: {
        "application/json": {
...
registry.registerPath({
  method: "patch",
  path: "/api/v1/forms/{slug}/fields/{fieldKey}",
  tags: ["Forms"],
...
registry.registerPath({
  method: "post",
  path: "/api/v1/forms/{slug}/fields/reorder",
  tags: ["Forms"],
